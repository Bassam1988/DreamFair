...
from ..services.storyboard_svc.storyboard import delete_storyboard_user_project_by_id, delete_storyboard_user_project_h_by_id, get_aspect_ratios, get_boards_per_mins, get_project_storyboard, get_script_styles, get_storyboard_styles, get_storyboard_user_project, \
...
def delete_project_h_by_id(request, project_h_id):
    data, message, succeeded, status = delete_storyboard_user_project_h_by_id(
        request, project_h_id)
    if succeeded:
        return {'data': data, 'message': message, 'status': status}
    else:
